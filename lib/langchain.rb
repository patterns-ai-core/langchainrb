...
module Langchain
  ...
  module Agent
    ...
    module RestGPTAgent
      autoload :APISelector, "langchain/agent/restgpt_agent/api_selector.rb"
      autoload :Caller, "langchain/agent/restgpt_agent/caller.rb"
      autoload :Main, "langchain/agent/restgpt_agent/main.rb"
      autoload :Planner, "langchain/agent/restgpt_agent/planner.rb"
      autoload :ResponseParser, "langchain/agent/restgpt_agent/response_parser.rb"
      autoload :Run, "langchain/agent/restgpt_agent/run.rb"
      autoload :Utils, "langchain/agent/restgpt_agent/utils.rb"
      autoload :SimpleResponseParser, "langchain/agent/restgpt_agent/simple_response_parser.rb"
    end
  end
  ...
  module Tool
    ...
    autoload :RubyREPL, "langchain/tool/ruby_repl"
