...
module Langchain::Tool
  ...
  class NewsRetriever
    ...
    def get_everything(
      ...
      Langchain.logger.info("#{self.class} - Retrieving all news")
    ...
    def get_top_headlines(
      ...
      Langchain.logger.info("#{self.class} - Retrieving top news headlines")
    ...
    def get_sources(
      ...
      Langchain.logger.info("#{self.class} - Retrieving news sources")
