...
module Langchain::LLM
  ...
  class OpenAI < Base
    ...
    # @return [Langchain::LLM::Response::OpenAI] LLM response object with embedding as a value
    #
    ...
    # @return [Langchain::LLM::Response::OpenAI] LLM response object with response messages as a value
    #
