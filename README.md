...
| "weather"  | Calls Open Weather API to retrieve the current, forecast, and historical weather        |      `ENV["OPEN_WEATHER_APE_KEY]` (https://home.openweathermap.org/api_keys)               | `gem "open-weather-ruby-client", "~> 0.3.0""`     |
