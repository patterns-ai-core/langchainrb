...
RSpec.describe Langchain::LLM::GooglePalm do
  ...
  describe "#chat" do
    ...
    context "when prompt is passed in" do
      ...
      it "returns a message" do
        expect(subject.chat(prompt: completion).dig("candidates", 0, "content")).to eq("I am doing well, thank you for asking! I am excited to be able to help people with their tasks and to learn more about the world. How are you doing today?")
      end
