...
RSpec.describe Langchain::LLM::HuggingFace do
  ...
  describe "#embed" do
    context "when the embed_model is not passed as an argument" do
      let(:embedding) {
    ...
    context "when the embed_model is passed as an argument" do
      let(:embedding) {
  ...
  describe "#default_dimensions" do
    it "returns the default dimensions to 384" do
    ...
    context "when the dimensions is passed as an argument" do
      ...
      it "sets the default_dimensions to 1_024" do
