  ...
  describe "#complete" do
    ...
    context "with no additional parameters" do
      ...
      it "returns a completion" do
        expect(subject.complete(prompt: "Hello World").first_completion_text).to eq("\nWhat is the meaning of life? What is the meaning of life?\nWhat is the meaning")
      end
    end
    ...
    context "with additional parameters" do
      ...
      it "returns a completion" do
        expect(subject.complete(prompt: "Hello World", model: "j2-light", temperature: 0.7).first_completion_text).to eq(
          "\nWhat is the meaning of life? What is the meaning of life?\nWhat is the meaning"
        )
      end
    end
