  ...
  describe "#message" do
    ...
    context "with stream: true option and block passed in" do
      ...
      it "messages the model and yields the response" do
        ...
        expect(conversation.message(prompt)).to eq(Langchain::Conversation::Response.new(response.value))
      end
    end
    ...
    context "with simple prompt" do
      it "messages the model and returns the response" do
        ...
        expect(subject.message(prompt)).to eq(Langchain::Conversation::Response.new(response.value))
      end
    end
